...
# ! Main Class
class Tree(Generic[DT]):
    def __init__(
        self,
        value: Optional[DT]=None,
        *,
        sep: str="."
    ) -> None:
        self.children: Dict[str, Tree[DT]] = {}
        self.value: DT = value
        self.sep: str = sep
    ...
    def set(self, key: str, value: Optional[DT]) -> None: self._setter(key.split(self.sep), value)
    
    def to_dict(self): return self._to_dict()
    
    def get(self, key: str, default: DDT=None) -> Union[DDT, DT]:
